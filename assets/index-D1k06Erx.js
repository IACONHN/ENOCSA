...
`,f=`<section id="about" class="about">
  ...
  <div class="container">
    ...
    <div class="services-grid">
      ...
      <div class="card">
        <div class="card-img"><img src="./images/obras_civiles.jpeg" alt="Equpos de Construccion">
      ...
      <div class="card">
        <div class="card-img"><img src="./images/consultoria.jpeg" alt="Consultoría Técnica">
        </div>
        <div class="card-body">
  ...
  <div class="container">
    ...
    <div class="portfolio-grid">
      ...
      <div class="portfolio-card">
        <div class="card-images">
          <img src="./images/proyectos25/puente-ojosdeagua/puente_ojosdeagua1.jpeg" class="active"
            alt="PUENTEOJOSDEAGUA1">
          <img src="./images/proyectos25/puente-ojosdeagua/puente_ojosdeagua2.jpeg" class="active"
            alt="PUENTEOJOSDEAGUA2">
          <img src="./images/proyectos25/puente-ojosdeagua/puente_ojosdeagua3.jpeg" class="active"
            alt="PUENTEOJOSDEAGUA3">
          <img src="./images/proyectos25/puente-ojosdeagua/puente_ojosdeagua4.jpeg" class="active"
            alt="PUENTEOJOSDEAGUA4">
          <img src="./images/proyectos25/puente-ojosdeagua/puente_ojosdeagua5.jpeg" class="active"
            alt="PUENTEOJOSDEAGUA5">
          <img src="./images/proyectos25/puente-ojosdeagua/puente_ojosdeagua6.jpeg" class="active"
            alt="PUENTEOJOSDEAGUA6">
          <img src="./images/proyectos25/puente-ojosdeagua/puente_ojosdeagua7.jpeg" class="active"
            alt="PUENTEOJOSDEAGUA7">
          <img src="./images/proyectos25/puente-ojosdeagua/puente_ojosdeagua8.jpeg" class="active"
            alt="PUENTEOJOSDEAGUA8">
          <img src="./images/proyectos25/puente-ojosdeagua/puente_ojosdeagua9.jpeg" class="active"
            alt="PUENTEOJOSDEAGUA9">
          <img src="./images/proyectos25/puente-ojosdeagua/puente_ojosdeagua10.jpeg" class="active"
            alt="PUENTEOJOSDEAGUA10">
          <img src="./images/proyectos25/puente-ojosdeagua/puente_ojosdeagua11.jpeg" class="active"
            alt="PUENTEOJOSDEAGUA11">
          <img src="./images/proyectos25/puente-ojosdeagua/puente_ojosdeagua12.jpeg" class="active"
            alt="PUENTEOJOSDEAGUA12">
          <img src="./images/proyectos25/puente-ojosdeagua/puente_ojosdeagua13.jpeg" class="active"
            alt="PUENTEOJOSDEAGUA13">
          <img src="./images/proyectos25/puente-ojosdeagua/puente_ojosdeagua14.jpeg" class="active"
            alt="PUENTEOJOSDEAGUA14">
          <img src="./images/proyectos25/puente-ojosdeagua/puente_ojosdeagua15.jpeg" class="active"
            alt="PUENTEOJOSDEAGUA15">
          <img src="./images/proyectos25/puente-ojosdeagua/puente_ojosdeagua16.jpeg" class="active"
      ...
      <div class="portfolio-card">
        <div class="card-images">
          <img src="./images/proyectos25/remodelacion-residencia/remodelacion1.jpeg" class="active" alt="RESIDENCIA1">
          <img src="./images/proyectos25/remodelacion-residencia/remodelacion2.jpeg" class="active" alt="RESIDENCIA2">
          <img src="./images/proyectos25/remodelacion-residencia/remodelacion3.jpeg" class="active" alt="RESIDENCIA3">
          <img src="./images/proyectos25/remodelacion-residencia/remodelacion4.jpeg" class="active" alt="RESIDENCIA4">
          <img src="./images/proyectos25/remodelacion-residencia/remodelacion5.jpeg" class="active" alt="RESIDENCIA5">
          <img src="./images/proyectos25/remodelacion-residencia/remodelacion6.jpeg" class="active" alt="RESIDENCIA6">
          <img src="./images/proyectos25/remodelacion-residencia/remodelacion7.jpeg" class="active" alt="RESIDENCIA7">
          <img src="./images/proyectos25/remodelacion-residencia/remodelacion8.jpeg" class="active" alt="RESIDENCIA8">
          <img src="./images/proyectos25/remodelacion-residencia/remodelacion9.jpeg" class="active" alt="RESIDENCIA9">
          <img src="./images/proyectos25/remodelacion-residencia/remodelacion10.jpeg" class="active" alt="RESIDENCIA10">
          <img src="./images/proyectos25/remodelacion-residencia/remodelacion11.jpeg" class="active" alt="RESIDENCIA11">
          <img src="./images/proyectos25/remodelacion-residencia/remodelacion12.jpeg" class="active" alt="RESIDENCIA12">
          <img src="./images/proyectos25/remodelacion-residencia/remodelacion13.jpeg" class="active" alt="RESIDENCIA13">
          <img src="./images/proyectos25/remodelacion-residencia/remodelacion14.jpeg" class="active" alt="RESIDENCIA14">
          <img src="./images/proyectos25/remodelacion-residencia/remodelacion15.jpeg" class="active" alt="RESIDENCIA15">
          <img src="./images/proyectos25/remodelacion-residencia/remodelacion16.jpeg" class="active" alt="RESIDENCIA16">
          <div class="card-buttons">
            <button class="prev">&#10094;</button>
            <button class="next">&#10095;</button>
          </div>
      ...
      <div class="portfolio-card">
        <div class="card-images">
          <img src="./images/proyectos25/reposicion-agua-guaimaca/reposicion1.jpeg" class="active"
            alt="REPOSICIONGUAIMACA1">
          <img src="./images/proyectos25/reposicion-agua-guaimaca/reposicion2.jpeg" class="active"
            alt="REPOSICIONGUAIMACA2">
          <img src="./images/proyectos25/reposicion-agua-guaimaca/reposicion3.jpeg" class="active"
            alt="REPOSICIONGUAIMACA3">
          <img src="./images/proyectos25/reposicion-agua-guaimaca/reposicion4.jpeg" class="active"
            alt="REPOSICIONGUAIMACA4">
          <img src="./images/proyectos25/reposicion-agua-guaimaca/reposicion5.jpeg" class="active"
            alt="REPOSICIONGUAIMACA5">
          <img src="./images/proyectos25/reposicion-agua-guaimaca/reposicion6.jpeg" class="active"
            alt="REPOSICIONGUAIMACA6">
          <img src="./images/proyectos25/reposicion-agua-guaimaca/reposicion7.jpeg" class="active"
            alt="REPOSICIONGUAIMACA7">
          <img src="./images/proyectos25/reposicion-agua-guaimaca/reposicion8.jpeg" class="active"
      ...
      <div class="portfolio-card">
        <div class="card-images">
          <img src="./images/proyectos25/pavimentacion-elporvenir/pavelporvenir1.jpeg" class="active" alt="PAVELPORVENIR1">
          <img src="./images/proyectos25/pavimentacion-elporvenir/pavelporvenir2.jpeg" class="active" alt="PAVELPORVENIR2">
          <img src="./images/proyectos25/pavimentacion-elporvenir/pavelporvenir3.jpeg" class="active" alt="PAVELPORVENIR3">
          <img src="./images/proyectos25/pavimentacion-elporvenir/pavelporvenir4.jpeg" class="active" alt="PAVELPORVENIR4">
          <img src="./images/proyectos25/pavimentacion-elporvenir/pavelporvenir5.jpeg" class="active" alt="PAVELPORVENIR5">
          <img src="./images/proyectos25/pavimentacion-elporvenir/pavelporvenir6.jpeg" class="active" alt="PAVELPORVENIR6">
          <img src="./images/proyectos25/pavimentacion-elporvenir/pavelporvenir7.jpeg" class="active" alt="PAVELPORVENIR7">
          <img src="./images/proyectos25/pavimentacion-elporvenir/pavelporvenir8.jpeg" class="active" alt="PAVELPORVENIR8">
          <img src="./images/proyectos25/pavimentacion-elporvenir/pavelporvenir9.jpeg" class="active" alt="PAVELPORVENIR9">
          <img src="./images/proyectos25/pavimentacion-elporvenir/pavelporvenir10.jpeg" class="active" alt="PAVELPORVENIR10">
          <img src="./images/proyectos25/pavimentacion-elporvenir/pavelporvenir11.jpeg" class="active" alt="PAVELPORVENIR11">
          <img src="./images/proyectos25/pavimentacion-elporvenir/pavelporvenir12.jpeg" class="active" alt="PAVELPORVENIR12">
          <img src="./images/proyectos25/pavimentacion-elporvenir/pavelporvenir13.jpeg" class="active" alt="PAVELPORVENIR13">
          <img src="./images/proyectos25/pavimentacion-elporvenir/pavelporvenir14.jpeg" class="active" alt="PAVELPORVENIR14">
          <div class="card-buttons">
            <button class="prev">&#10094;</button>
            <button class="next">&#10095;</button>
          </div>
      ...
      <div class="portfolio-card">
        <div class="card-images">
          <img src="./images/proyectos25/pavimentacion-guaimaca/pavguaimaca1.jpeg" class="active" alt="PAVGUAIMACA1">
          <img src="./images/proyectos25/pavimentacion-guaimaca/pavguaimaca2.jpeg" class="active" alt="PAVGUAIMACA2">
          <img src="./images/proyectos25/pavimentacion-guaimaca/pavguaimaca3.jpeg" class="active" alt="PAVGUAIMACA3">
          <img src="./images/proyectos25/pavimentacion-guaimaca/pavguaimaca4.jpeg" class="active" alt="PAVGUAIMACA4">
          <img src="./images/proyectos25/pavimentacion-guaimaca/pavguaimaca5.jpeg" class="active" alt="PAVGUAIMACA5">
          <img src="./images/proyectos25/pavimentacion-guaimaca/pavguaimaca6.jpeg" class="active" alt="PAVGUAIMACA6">
          <img src="./images/proyectos25/pavimentacion-guaimaca/pavguaimaca7.jpeg" class="active" alt="PAVGUAIMACA7">
          <img src="./images/proyectos25/pavimentacion-guaimaca/pavguaimaca8.jpeg" class="active" alt="PAVGUAIMACA8">
          <img src="./images/proyectos25/pavimentacion-guaimaca/pavguaimaca9.jpeg" class="active" alt="PAVGUAIMACA9">
          <img src="./images/proyectos25/pavimentacion-guaimaca/pavguaimaca10.jpeg" class="active" alt="PAVGUAIMACA10">
          <img src="./images/proyectos25/pavimentacion-guaimaca/pavguaimaca11.jpeg" class="active" alt="PAVGUAIMACA11">
          <img src="./images/proyectos25/pavimentacion-guaimaca/pavguaimaca12.jpeg" class="active" alt="PAVGUAIMACA12">
          <img src="./images/proyectos25/pavimentacion-guaimaca/pavguaimaca13.jpeg" class="active" alt="PAVGUAIMACA13">
          <img src="./images/proyectos25/pavimentacion-guaimaca/pavguaimaca14.jpeg" class="active" alt="PAVGUAIMACA14">
          <div class="card-buttons">
            <button class="prev">&#10094;</button>
            <button class="next">&#10095;</button>
          </div>
